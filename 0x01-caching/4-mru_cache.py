...
class MRUCache(BaseCaching):
    ...
    Inherits from BaseCaching and implements a Most Recently Used (MRU)
    ...
    def __init__(self):
        ...
        where the most recently used items are at the end of the deque.
        """
        super().__init__()
        self.order = deque()
    ...
    def put(self, key, item):
        ...
        recently used. If the cache exceeds its limit, the most recently used
        item is removed.
